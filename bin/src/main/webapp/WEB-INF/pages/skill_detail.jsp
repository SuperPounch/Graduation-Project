            ...
            <div class="panel heading-border">
                <form:form action="/skill/to_detail" modelAttribute="skill"  id="admin-form" name="addForm">
                    <div class="panel-body bg-light">
                        ...
                        <td>
                            <img src="/upload/${skill.skillid}/${skill.skillid}1.png" style="max-height: 600px;max-width: 600px"/>
                        </td>
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <div id="product" class="main">
                    ...
                    <div class="infos">
                        <div class="ncon">
                            <p><span class="intro">${skill.text}</span></p>
                            <p><span class="introdate">${skill.createdate}</span></p>
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
