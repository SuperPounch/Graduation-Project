    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form action="/comment/update" modelAttribute="comment"  id="admin-form" name="addForm">
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="userid" class="field prepend-icon">
                                    <form:input path="userid" cssClass="gui-input" placeholder="用户编号..." />
                            ...
                            <div class="col-md-6">
                                <label for="category" class="field prepend-icon">
                                    <form:input path="category" cssClass="gui-input" placeholder="类别..." />
