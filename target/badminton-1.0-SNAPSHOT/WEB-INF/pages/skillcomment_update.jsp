    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form action="/skillComment/update" modelAttribute="comment" id="admin-form" name="addForm">
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="skillid" class="field prepend-icon">技巧帖编号
                                    <input id="skillid" name="skillid" class="gui-input" placeholder="技巧帖编号..."
                                           value="${comment.skillid}"/>
