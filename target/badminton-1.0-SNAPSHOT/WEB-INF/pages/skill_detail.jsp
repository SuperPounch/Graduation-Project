        ...
        <div class="tray tray-center">
            ...
            <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
                <div class="panel heading-border">
                    <form:form action="/skill/to_detail" modelAttribute="skill" id="admin-form" name="addForm">
                        <div class="panel-body bg-light">
                            ...
                            <div class="section row">
                                <div class="col-md-6">
                                    <label for="skillid" class="field prepend-icon">
                                        <form:textarea path="skillid" cssClass="gui-input" placeholder="Skill编号..."/>
                                        <label for="skillid" class="field-icon">
                                        </label>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label for="category" class="field prepend-icon">
                                        <form:textarea path="category" cssClass="gui-input" placeholder="类别..."
                                                       items="${category}"/>
                           ...
                           <%-- <td>
                                <img src="/upload/${skill.skillid}/${skill.skillid}1.png"
...
<c:if test="${sessionScope.user.level==1||sessionScope.user.level==0}">
    <div id="main" class="wrap">
        ...
        <div id="product" class="main">
            ...
            <div class="infos">
                <div class="ncon">
                    <p style="color: #f0ad4e"><span class="intro" style="margin-left:25%">来源: ${skill.source}
                        <span style="margin-left: 20%">所属类别: ${skill.category}</span></span></p>
                    <p><span class="intro">正文: ${skill.text}</span></p>
                    <p><span class="introdate">日期：<spring:eval expression="skill.createdate"/></span></p>
                </div>
                <div class="clear"/>
            </div>
        </div>
            ...
            <div class="wrapper">
                <div class="ds-post-main">
                    <div class="ds-comment-body">
                        <c:forEach items="${skill.commentList}" var="list">
                            <div class="wrapper">
                                ...
                                <p CLASS="user-name">评论ID:${reply.commentid}-内容:${reply.content}-技巧帖ID:${reply.skillid}
                                    -所属:<c:if test="${reply.iscomment==0}">
                                        帖评论
                                    </c:if>
    ...
    <script>
        ...
        $(".reply").click(function () {
            ...
            var f = $('<form method="get" action="/skillComment/addself"></form>');
            ...
            f.append($('<input name="skillid" hidden readonly>').val(${skill.skillid}));
