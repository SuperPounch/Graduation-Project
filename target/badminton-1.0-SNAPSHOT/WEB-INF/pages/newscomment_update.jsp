    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form action="/newsComment/update" modelAttribute="comment" id="admin-form" name="addForm">
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="newsid" class="field prepend-icon">新闻编号
                                    <input id="newsid" name="newsid" class="gui-input" placeholder="新闻编号..."
                                           value="${comment.newsid}"/>
