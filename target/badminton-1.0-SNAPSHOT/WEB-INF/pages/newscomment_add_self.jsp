    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form action="/newsComment/addself" modelAttribute="comment" id="admin-form" name="addForm">
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="content" class="field prepend-icon">
                                    <form:textarea path="content" cssClass="gui-input" placeholder="评论内容..." cssStyle="resize: none" rows="3"/>
