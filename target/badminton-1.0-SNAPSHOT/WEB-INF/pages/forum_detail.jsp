                    ...
                    <form:form action="/forum/to_detail" modelAttribute="forum" id="admin-form" name="addForm">
                        <div class="panel-body bg-light">
                            ...
                            <div class="section">
                                ...
                                <%--<td>
                                    <img src="/upload/${forum.forumid}/${forum.forumid}1.png"
...
<c:if test="${sessionScope.user.level==1||sessionScope.user.level==0}">
    ...
    <div id="main" class="wrap">
        ...
        <div id="product" class="main">
            ...
            <div class="infos">
                <div class="ncon">
                    <p><span class="intro" style="margin-left:25%">来源:${forum.source}
                    <span style="margin-left: 20%">所属类别: ${forum.category}</span></span></p>
                    <p><span class="intr">正文:${forum.text}</span></p>
                    <p><span class="introdate">日期：<spring:eval expression="forum.createdate"/></span></p>
                </div>
                <div class="clear"/>
            </div>
        </div>
            ...
            <div class="wrapper">
                <div class="ds-post-main">
                    <div class="ds-comment-body">
                        ...
                        <c:forEach items="${forum.commentList}" var="list">
                            <div class="wrapper">
                                ...
                                <p CLASS="user-name">回复ID${reply.commentid}:内容:${reply.content}--帖子ID:${reply.forumid}--所属:
                                ...
                                --日期：<spring:eval expression="reply.date"/>
                                </p>
                                </c:forEach>
                                </p>
                            </div>
    ...
    <script>
        ...
        $(".reply").click(function () {
            ...
            var f = $('<form method="get" action="/forumComment/addself"></form>');
            ...
            f.append($('<input name="forumid" hidden readonly>').val(${forum.forumid}));
